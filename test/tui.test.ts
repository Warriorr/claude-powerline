...
function makeTuiData(overrides: Partial<TuiData> = {}): TuiData {
  return {
    ...
    blockInfo: { cost: 0.12, tokens: 5000, weightedTokens: 5000, timeRemaining: 3600, timeElapsed: null, burnRate: 0.45, tokenBurnRate: null, rateLimitPercentage: null, resetsAt: null, projectedUsagePercentage: null, projectedUsageTrend: null, minutesToLimit: null },
